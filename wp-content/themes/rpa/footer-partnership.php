      ...
      <div class="footer">
        <div class="grid vertical-5xl">
          ...
          <div id="w-node-_16b5ff3c-0ea0-ad44-3bc0-5a25cd9ed254-cd9ed24d" class="vertical-m">
            ...
            <div>
            <a href="#Offering" class="display-block color-primary">Offering</a>
              <a href="#Comparison" class="display-block color-primary">Comparison</a>
              <a href="#price" class="display-block color-primary">Prices</a>
              <a href="#reviews" class="display-block color-primary">Reviews</a>
              <a href="#faq" class="display-block color-primary">FAQ</a>
            </div>
          </div>
