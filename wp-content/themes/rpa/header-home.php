        ...
        <div style="background-color:rgba(255,255,255,0.5)" class="nav---container">
          ...
          <nav role="navigation" class="nav-menu w-nav-menu">
            <div class="nav---menu-inner">
              ...
              <a href="#price" class="nav---link w-nav-link">Pricing</a>
              <a href="#faq" class="nav---link w-nav-link">FAQ</a>
              <a href="/partnership" class="nav---link w-nav-link">Partnership</a>
              <a href="#reviews" class="nav---link w-nav-link">Reviews</a>
              <div class="nav---button">
                <div class="button_wrap">
                  <a data-w-id="6acc2762-d515-155d-4154-6fc628f97c6e" href="#popmake-141" class="button nav_bar w-button">Let&#x27;s talk</a>
                </div>
              </div>
            </div>
          </nav>
